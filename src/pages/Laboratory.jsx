 ...
 * Showcases the laboratory facilities at sanskrithi School of Engineering
 */
const Laboratory = () => {
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <p className="lead mb-5">
                Join sanskrithi School of Engineering to access our state-of-the-art laboratories
              </p>
