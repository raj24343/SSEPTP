        ...
        <Container className="py-4">
          <Row className="align-items-center">
            ...
            <Col lg={8}>
              ...
              <p className="mb-4">
                As the Principal of sanskrithi School of Engineering, I am proud to lead an institution that strives for excellence in engineering education. Our focus on holistic development ensures that students graduate not just with a degree, but with the skills, knowledge, and values needed to excel in their careers.
              </p>
              <p>
